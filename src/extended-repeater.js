  ...
  if (options.additionRepeatTimes) {
    if (options.addition || options.addition !== undefined) {
      if (options.additionSeparator) {
        str += options.addition + (options.additionSeparator + options.addition).repeat(options.additionRepeatTimes - 1)
      } else {
        str += options.addition + ("|" + options.addition).repeat(options.additionRepeatTimes - 1)
      }
    } else {
      if (options.additionSeparator) {
